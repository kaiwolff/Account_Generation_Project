...
class TestAccessRights(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        super(TestAccessRights, self).__init__(*args, **kwargs)
        UserAccountDetails().create_new_user("TestUser", "test_first", "test_last", "1990", "YVW-5DMBUvTJfJ")
        UserAccountDetails().delete_user("NewAdmin", "admin", "admin")
